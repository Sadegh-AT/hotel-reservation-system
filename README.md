...
با استفاده از `RESTful API`، برنامه از یک ساختار استاندارد برای ارتباط با سرورها استفاده می‌کند که امکان ارسال و دریافت درخواست‌ها و داده‌ها را فراهم می‌کند. در این بخش، یک راهنمای کامل از API های برنامه را آماده کرده‌ایم تا هیچ سوالی برای شما باقی نماند.
